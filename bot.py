...
CHAT_ID = "@remontvl25chat"  # ID чата для публикации заявок
CHAT_LINK = "@remontvl25chat"  # Ссылка для отображения
...
👇 **Мастера, откликайтесь в комментариях!**
    ...
    bot.send_message(
        message.chat.id,
        "✅ **ЗАЯВКА ОПУБЛИКОВАНА!**\n\n"
        f"📢 Чат с мастерами: @remontvl25chat\n"
